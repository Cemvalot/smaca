...
<div class="dashboard-section" id="environmental" data-section="environmental">
          ...
          <div class="environmental-main-grid">
            ...
            <aside class="card environmental-summary-card">
              ...
              <div class="card__body">
                <div class="stat-row"><span class="stat-row__label">Current UV Level</span><span id="env-summary-current" class="stat-row__value">6.5 ({{ __('messages.status.high') }})</span></div>
          ...
          <div class="environmental-bottom-grid">
            <section class="card">
              ...
              <div class="card__body environmental-pattern-body">
                ...
                <div class="environmental-zone-grid" aria-label="UV exposure zones">
                  ...
                  <span class="environmental-zone environmental-zone--very-high">{{ __('messages.status.very_high') }} (8-10)</span>
            ...
            <section class="card environmental-meaning-card">
              ...
              <div class="card__body">
                ...
                <p id="env-meaning-level" class="environmental-meaning-level">Current interpretation: {{ __('messages.status.high') }} UV exposure</p>
