  ...
  <div class="app">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar__nav">
        <a href="#overview" class="nav-link nav-link--section is-active" data-section="overview">
        ...
        <a href="#iaq" class="nav-link nav-link--section" data-section="iaq">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
          <span class="nav-link__text">Indoor Air Quality</span>
        </a>
        <a href="#occupancy" class="nav-link nav-link--section" data-section="occupancy">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
          </svg>
          <span class="nav-link__text">Occupancy</span>
        </a>
        <a href="#energy" class="nav-link nav-link--section" data-section="energy">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
          </svg>
          <span class="nav-link__text">Energy</span>
        </a>
        <a href="#connectivity" class="nav-link nav-link--section" data-section="connectivity">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0"></path>
          </svg>
          <span class="nav-link__text">Connectivity</span>
        </a>
        <a href="#environmental" class="nav-link nav-link--section" data-section="environmental">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
          </svg>
          <span class="nav-link__text">Environmental / UV</span>
        </a>
        <a href="#ai-insights" class="nav-link nav-link--section" data-section="ai-insights">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
          </svg>
          <span class="nav-link__text">AI Insights</span>
        </a>
        <a href="#management" class="nav-link nav-link--section nav-link--admin-only" data-section="management" data-admin-only title="Admin only">
          <svg class="nav-link__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card">
              ...
              <div class="card__body">
                <div class="quick-links-grid">
                  <a href="#iaq" class="btn btn--secondary quick-link" data-section="iaq">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    Indoor Air Quality
                  </a>
                  <a href="#occupancy" class="btn btn--secondary quick-link" data-section="occupancy">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    Occupancy
                  </a>
                  <a href="#energy" class="btn btn--secondary quick-link" data-section="energy">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                    </svg>
                    Energy
                  </a>
                  <a href="#connectivity" class="btn btn--secondary quick-link" data-section="connectivity">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0"></path>
                    </svg>
                    Connectivity
                  </a>
                  <a href="#environmental" class="btn btn--secondary quick-link" data-section="environmental">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
                    Environmental / UV
                  </a>
                  <a href="#ai-insights" class="btn btn--secondary quick-link" data-section="ai-insights">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                    </svg>
                    AI Insights
        ...
        <div class="dashboard-section" id="management" data-section="management" data-admin-only style="display: none;">
          <div class="section-hero section-hero--management">
            <div class="section-hero__inner">
              ...
              <div class="section-hero__stat"><div id="management-total-sensors" class="section-hero__stat-value">13</div><div class="section-hero__stat-label">Total sensors</div></div>
            </div>
          </div>
          ...
          <div class="grid grid--metrics grid--metrics-4" style="margin-bottom: var(--space-6);">
            <div class="stat-card" title="Total number of sensors in the system">
              <div class="stat-card__content">
                ...
                <div class="stat-card__value" id="total-sensors">13</div>
                <div class="stat-card__unit"></div>
              </div>
            </div>
            <div class="stat-card" title="Sensors currently online and reporting data">
              <div class="stat-card__content">
                ...
                <div class="stat-card__value" id="active-sensors">12</div>
                <div class="stat-card__unit"></div>
              </div>
            </div>
            <div class="stat-card" title="Sensors requiring maintenance (low battery, errors, etc.)">
              <div class="stat-card__content">
                ...
                <div class="stat-card__value" id="maintenance-sensors">1</div>
                <div class="stat-card__unit"></div>
              </div>
            </div>
              ...
              <div class="card__body" style="padding: 0;">
                <table id="sensors-management-table" style="width: 100%; border-collapse: collapse;">
                  ...
                  <tbody id="sensors-management-table-body">
                    <!-- Sensors will be loaded here via JavaScript -->
                  </tbody>
                </table>
              </div>
            </div>
